...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.8 docker.io/mariadb:10.11.13 docker.io/memcached:1.6.39-alpine docker.io/manticoresearch/manticore:14.1.0" \
    "${container}"
# Commit the image
