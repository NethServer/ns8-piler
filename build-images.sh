...
<<<<<<< upgrade1.46
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.7b docker.io/mariadb:10.11.11 docker.io/memcached:1.6.38-alpine docker.io/manticoresearch/manticore:6.3.8" \
=======
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.4 docker.io/mariadb:10.11.11 docker.io/memcached:1.6.26-alpine" \
>>>>>>> main
    "${container}"
# Commit the image
