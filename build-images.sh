...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=ghcr.io/nethserver/piler-server:latest docker.io/mariadb:10.11.18 docker.io/memcached:1.6.42-alpine docker.io/manticoresearch/manticore:14.1.0" \
    "${container}"
# Commit the image
