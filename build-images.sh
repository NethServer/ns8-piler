...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.8 docker.io/mariadb:12.0.2 docker.io/memcached:1.6.39-alpine docker.io/manticoresearch/manticore:10.1.0" \
    "${container}"
# Commit the image
