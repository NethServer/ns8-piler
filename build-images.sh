...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=ghcr.io/nethserver/piler-server:latest-ae2d199 docker.io/mariadb:10.11.18 docker.io/memcached:1.6.45-alpine docker.io/manticoresearch/manticore:14.1.0" \
    "${container}"
# Commit the image
