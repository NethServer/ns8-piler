...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.8 docker.io/mariadb:10.11.16 docker.io/memcached:1.6.41-alpine docker.io/manticoresearch/manticore:17.5.100" \
    "${container}"
# Commit the image
