...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.7b docker.io/mariadb:10.11.13 docker.io/memcached:1.6.38-alpine docker.io/manticoresearch/manticore:9.3.2" \
    "${container}"
# Commit the image
