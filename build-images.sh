...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.8 docker.io/mariadb:10.11.18 docker.io/memcached:1.6.45-alpine docker.io/manticoresearch/manticore:29.0.2" \
    "${container}"
# Commit the image
