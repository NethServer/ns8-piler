...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.7c docker.io/mariadb:10.11.13 docker.io/memcached:1.6.39-alpine docker.io/manticoresearch/manticore:13.2.3" \
    "${container}"
# Commit the image
