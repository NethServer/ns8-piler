...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.8 docker.io/mariadb:10.11.18 docker.io/memcached:1.6.44-alpine docker.io/manticoresearch/manticore:10.1.0" \
    "${container}"
# Commit the image
