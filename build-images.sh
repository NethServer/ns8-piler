...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/sutoj/piler:1.4.8 docker.io/mariadb:10.11.16 docker.io/memcached:1.6.41-alpine docker.io/manticoresearch/manticore:25.0.0" \
    "${container}"
# Commit the image
